#ifndef HYBRID_INTEGRATOR_HPP
#define HYBRID_INTEGRATOR_HPP

// #include "CROSP/numerical_integrators/cosserat_rod_integrators.hpp"
#include "idm_integrators/idm_integrators.hpp"


namespace CROSP::numerical_integrators::hybrid_integrator {


struct HybridIntegrator{


    HybridIntegrator(const polynomial_representation::PolynomialRepresentation t_polynomial_representation,
...
typedef std::shared_ptr<HybridIntegrator> IntegratorsSPtr;
...
}   //  CROSP::numerical_integrators::hybrid_integrator

#endif // HYBRID_INTEGRATOR_HPP
