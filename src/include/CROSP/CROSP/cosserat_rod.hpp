...
//    }
    ...
    ::LieAlgebra::Vector6d IDM(const Eigen::VectorXd &t_qe,
                               const Eigen::VectorXd &t_dot_qe,
                               const Eigen::VectorXd &t_ddot_qe,
                               const Eigen::Vector4d &t_initial_quaternion=Eigen::Vector4d(1, 0, 0, 0),
                               const Eigen::Vector3d &t_initial_position=Eigen::Vector3d::Zero(),
                               const ::LieAlgebra::Vector6d &t_initial_twist=::LieAlgebra::Vector6d::Zero(),
                               const ::LieAlgebra::Vector6d &t_initial_acceleration=::LieAlgebra::Vector6d::Zero(),
                               const LieAlgebra::Vector6d &t_Lambda_X1=::LieAlgebra::Vector6d::Zero())
    {
        m_cosserat_rod_integrators->updateParameterisation(t_qe, t_dot_qe, t_ddot_qe);
    ...
    Eigen::VectorXd getStaticInternalBalance(const Eigen::VectorXd &t_qe)const
    {
        ...
        const Eigen::VectorXd internal_balance = Qa - Q_ad - Qe ;
                                       ...
                                       const Eigen::VectorXd &t_dot_qe)const
    {
        ...
        const Eigen::VectorXd internal_balance = Qa - Q_ad - Qe - Ce;
        return internal_balance;
    ...
    Eigen::VectorXd getTangentStaticInternalBalance(const Eigen::VectorXd &t_Delta_qe)const
    {
        ...
        Eigen::VectorXd Delta_internal_balance = Delta_Qa - Delta_Qe;
                                              ...
                                              const Eigen::VectorXd &t_Delta_dot_qe)const
    {
        ...
        Eigen::VectorXd Delta_internal_balance = Delta_Qa - Delta_Qe - Delta_Ce;
        return Delta_internal_balance;
    }
