function [T,q,q_dot,q_dot_dot] = Time_integration_Newton_beam_released_spectral(t,Const,Config)
...
%     grid on
    ...
    while norm(r(7:end)) > r_min      
        ...
        J_complete = -J - a*Const.Dee - Const.Kee;
                
        Delta_q_k =  J_complete\r(7:end);
